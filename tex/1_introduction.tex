...
Today there are several textbooks dedicated specifically to this area, such as~\cite{Manning:1999aa},~\cite{Jurafsky:2014aa} and~\cite{Clark:2013aa} as well as much overlap in the field of Information Retrieval (see~\cite{Manning:2008aa},~\cite{Leskovec:2014aa} and for an slightly dated coverage of the topic~\cite{Rijsbergen:1979aa}), a field rose to popularity during the late 1980's due to the Internet starting to become a mainstream medium.

Text classification, also referred to as Text Categorization, has been of a problem  of interest for decades. The applications are various, from document filtering, automated metadata generation such as language classification to automatic email labeling, spam identification and sentiment detection, amongst others.
