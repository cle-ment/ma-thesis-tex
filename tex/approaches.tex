...
\section{Methods for Text Classification}
\label{sec:Methods for Text Classification}
...
\label{subs:Distributed Representations}
...
\label{sub:Text Classification with Vector Space Models}
...
Kernel Methods can be seen as a set of instance-based methods which are explained in Section~\ref{par:Instance-based Methods}. The best known member of is the \gls{svm}.
...
\subsection{Evaluation of Text Classification Methods}
\label{sub:Evaluation of Text Classification Methods}
