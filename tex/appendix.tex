...
\includepdf[scale=0.85,pagecommand={\section{Appendix \label{B}: Experiments}\subsection{Understanding How Humans Structure Text}\label{sub:Understanding How Humans Structure Text}}, pages=1, offset=75 -75]{appendix/InferringStructureofJobAdvertisements-experiment-example.pdf}
\includepdf[scale=0.85, pagecommand={}, pages=2-, offset=75 -75]{appendix/InferringStructureofJobAdvertisements-experiment-example.pdf}
