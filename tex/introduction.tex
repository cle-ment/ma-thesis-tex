...
\todo{add unsupervised learning (LDA etc) or remove reference in exploration}
...
Today there are textbooks dedicated specifically to this area, such as~\cite{MNNing:1999aa},~\cite{Jurafsky:2014aa} and~\cite{Clark:2013aa} There is also much overlap to the field of \gls{IR} that rose to popularity during the late 1980's due to the Internet starting to become a mainstream medium (see~\cite{MNNing:2008aa},~\cite{Leskovec:2014aa} and the classic work by~\cite{Rijsbergen:1979aa}).
...
The development process of the project was adapted from the double diamond design process developed by the by the British Design Council in 2005 (see ~\cite{Council:2007aa}). A design process is \textquote{the specific series of events, actions or methods by which a procedure or set of procedures are followed, in order to achieve an intended purpose, goal or outcome.}~\cite{Best:2006aa}. The process is shown in
...
- note to the reader:
- skip sections as there are explaining references
- all terms in the glossary are linked and if you're reading the print version color-coded
